...
[Route("/api/chatify")]
internal class ChatifyChatController : ControllerBase
{
    private readonly IChatifyAspNetCoreService _chatifyAspNetCoreService;

    public ChatifyChatController(IChatifyAspNetCoreService chatifyAspNetCoreService)
    {
    ...
    public async Task<IActionResult> AddChatMemberAsync(Guid chatId, [FromBody] AddChatMemberRequestDto request)
    {
    ...
    public async Task<IActionResult> ReadAsync([FromBody] ReadChatMessageRequestDto request)
    {
    ...
    public async Task<IActionResult> SendAsync(Guid chatId, [FromBody] SendChatMessageRequestDto request)
    {
